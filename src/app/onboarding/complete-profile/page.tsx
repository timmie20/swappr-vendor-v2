...
import { getServerVendorProfile } from "@/lib/auth/session";
...
export default async function CompleteProfilePage() {
  ...
  // Verify-business wrote the CAC record onto the vendor — fetch fresh so
  // the review form prefills with those values
